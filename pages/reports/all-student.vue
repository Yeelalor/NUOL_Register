...
export default {
  ...
  methods: {
    async onGetStudent() {
      try {
        await this.$axios.$get(`/report/students`,{params:{schoolYear:this.form.schoolYear,levelId: this.form.levelId,classId: this.form.classId}}).then((data) => {
